...
class PairWiseRankRunner():
    ...
    def __init__(self, tv = 0, ask= 0, mini_batch=1, added_comparison= 1, comparison= "Duration", layers =1, activation= "relu", load = "", save= "test", des= "des", results = "res", new_load = "n", gamma = 0.99, reward = 0.5, eps_decay = 10000, lr = 1e-4, low_reward = 0, high_reward = 1, mid_low_reward = 0, test_train = "test", batch_size = 128, mem_size = 10000, tau = 0.005, start= 0.9, test_frequency = 20, test_length = 50, env = "orig"):
    ...
    def test(self, mid_run= True, k= -1, stage = 0, num_test_rounds = 100, round_steps = 0):
        path= self.base_runner.pre_test(self, mid_run=mid_run)
        ...
        string1 = f"\nROUND {stage} - total steps = {self.total_steps} - {self.SAVE} - round steps = {correct}   "
        string2 = f""
